...
class NCSNpp_v2(nn.Module):
    ...
    def forward(self, x, y, t):
        ...
        # Keep spatial sizes compatible with the U-Net down/up sampling hierarchy.
        orig_h, orig_w = x.shape[2], x.shape[3]
        align_factor = 2 ** (self.num_resolutions - 1)
        pad_h = (align_factor - (orig_h % align_factor)) % align_factor
        pad_w = (align_factor - (orig_w % align_factor)) % align_factor
